        ...
        <section className={`${styles.skillsGraph} block`}>
            <Container>
                ...
                <div className={styles.intro}>
                    <h3>{`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur tristique arcu quis nibh rhoncus, vel faucibus lorem semper. Ut consequat mi id diam blandit.`}</h3>
