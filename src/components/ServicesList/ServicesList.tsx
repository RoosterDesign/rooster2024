    ...
    const services: LinkCardType[] = [
        {
            ...
            title: 'Contracting',
            link: '/services',
            body: `As a contractor, I bring flexibility and expertise to projects that require a skilled front-end developer.`
        },
        {
            ...
            title: 'Outsourcing',
            link: '/services',
            body: `For local agencies looking to expand their capacity, I offer my services as an outsourced resource.`
        },
        {
            ...
            title: 'Freelancing',
            link: '/services',
            body: `I also work directly with small businesses, offering bespoke front end development services.`
        }
    ]
    return (
