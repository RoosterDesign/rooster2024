        ...
        <section className={`${styles.skillsGraph} ${reverse ? styles.skillsGraphReverse : ''} block`}>
            <Container>
                ...
                <div className={styles.intro}>
                    <h2 className="h3">{`As a UI Designer and Front End Developer, I blend design and code to craft engaging websites, web applications, and software solutions that deliver a seamless and captivating user experience.`}</h2>
